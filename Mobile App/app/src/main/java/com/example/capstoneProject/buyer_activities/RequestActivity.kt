    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        descriptionEditText.addTextChangedListener(object : TextWatcher {
            override fun beforeTextChanged(s: CharSequence, start: Int, count: Int, after: Int) {
                ...
                counterTextView.setText("$convert/300")
            }
        ...
        val arrayList = getResources().getStringArray(R.array.services_category)
...
//        }
    ...
    private fun checkFirst(){
        if (ManageRequestActivity.serviceRequestGettingEdited == null) {
            button.setText("SUBMIT YOUR REQUEST")
        } else if (ManageRequestActivity.serviceRequestGettingEdited != null) {
            button.setText("UPDATE YOUR REQUEST")
...
//        }
        ...
        val serviceRequest = ServiceRequest(uid = ManageRequestActivity.serviceRequestGettingEdited!!.uid
            , title = titleEditText.text.toString()
            , description = descriptionEditText.text.toString()
            , price = priceEditText.text.toString().toInt()
            , userUid = currentUserUid
            , category = categoryEditText.text.toString()
            , userImage = ManageRequestActivity.serviceRequestGettingEdited!!.userImage
        )
